...
<body>
            ...
            <div class="collapse navbar-collapse" id="mainNavbar">
                ...
                <ul class="navbar-nav ms-auto align-items-lg-center">
                    ...
                    <li class="nav-item ms-lg-3">
                        <a href="<?= base_url('users/login') ?>" class="btn btn-primary">
                            Sign In
                        </a>
                    </li>
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8">
                    ...
                    <div class="hero-buttons mt-4">
                        ...
                        <a href="<?= base_url('users/register') ?>" class="btn btn-light">
                            Get Started
                        </a>

                        <a href="<?= base_url('users/login') ?>" class="btn btn-outline-light">
                            Sign In
                        </a>
        ...
        <div class="container">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    ...
                    <a href="<?= base_url('users/register') ?>" class="btn btn-primary">
                        Join Us
                    </a>
                ...
                <div class="col-md-6 text-center">
                    ...
                    <i class="fa fa-globe" style="font-size:180px;color:#0d6efd;"></i>
    ...
    <section id="contact" class="py-5">
        ...
        <div class="container text-center">
            ...
            <a href="<?= base_url('users/register') ?>" class="btn btn-primary btn-lg">
                Create Account
            </a>
